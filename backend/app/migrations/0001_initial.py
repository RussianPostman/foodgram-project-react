# Generated by Django 2.2.16 on 2022-11-24 18:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_to', to='app.Ingredient')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_to', to='app.Recipe'),
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
